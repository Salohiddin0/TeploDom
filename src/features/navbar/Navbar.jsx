  ...
  return (
    <>
      ...
      <nav className='py-5 flex flex-col'>
        <div className='flex items-center justify-between flex-wrap md:flex-nowrap gap-y-[22px]'>
          <Link
            to={'/'}
        ...
        <div className='hidden md:flex justify-between mt-[57px]'>
          <NavLink
            to={'/sale'}
            className='md:text-[14px] font-semibold p-[11px] px-[45px] md:px-[25px] rounded-[10px] 
             bg-[#EEEDED] cursor-pointer hover:bg-gradient-to-b hover:from-[#ffb12a] 
             hover:to-[#ef8100] hover:text-white'
          >
            Товары по акции
          </NavLink>
