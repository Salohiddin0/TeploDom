...
const ProductDetail = () => {
  ...
  return (
    <section className='detail-product bg-[#FAFAFA] min-h-[70vh]'>
      <div className='container mx-auto py-5 md:py-[50px] px-4'>
        {product && (
          <div className='bg-white rounded-[20px] overflow-hidden'>
            <div className='flex flex-col md:grid md:grid-cols-3 md:gap-[50px] md:px-[25px] md:py-[30px] md:pr-[60px]'>
              <div className='w-full md:col-span-1 p-4 md:p-0'>
                <img
              ...
              <div className='flex flex-col p-4 md:p-0 md:col-span-2'>
                <h1 className='text-2xl md:text-[30px] font-semibold mb-4 md:mb-[30px]'>
                  {product.title}
                </h1>

                <p className='text-base md:text-[18px] font-medium mb-[33px]'>
                  {product.desc}
                </p>

                <div className='flex items-center gap-2 mb-[33px] text-[#000000]'>
                  <svg
                    width='25'
                    height='25'
                    viewBox='0 0 30 22'
                ...
                <p className='text-2xl md:text-[40px] font-medium mb-6 md:mb-10'>
                  {product.price} сум
                </p>

                <div className='flex md:flex-row items-center gap-4'>
                  <button className='flex items-center gap-2 border-2 border-black text-white p-[10px] rounded-lg transition-colors'>
                    <svg
                      width='36'
                      height='36'
                      viewBox='0 0 36 36'
                  ...
                  <div className='flex items-center gap-3 md:gap-[20px]'></div>

                  <div className='btn-group flex items-center border-2 border-[#b6b6b6] rounded-lg w-fit'>
                    <button className='p-2 md:p-3 w-[50px] md:w-[60px] h-[50px] md:h-[60px] flex items-center justify-center'>
                      <svg
                        width='24'
                        height='24'
                        viewBox='0 0 36 36'
                    ...
                    <button className='p-2 md:p-3 w-[50px] md:w-[60px] h-[50px] md:h-[60px] flex items-center justify-center border-x-2 border-[#b6b6b6] text-2xl md:text-[36px] font-medium'>
                      2
                    </button>
                    <button className='p-2 md:p-3 w-[50px] md:w-[60px] h-[50px] md:h-[60px] flex items-center justify-center'>
                      <svg
